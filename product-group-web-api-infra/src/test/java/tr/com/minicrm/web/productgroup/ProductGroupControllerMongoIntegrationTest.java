...
@SpringBootTest(properties = {"spring.main.allow-bean-definition-overriding=true",
    "platform.datasource.databaseType=mongo", "spring.liquibase.enabled=false"})
@AutoConfigureMockMvc
public class ProductGroupControllerMongoIntegrationTest {
  ...
  static class ProductGroupInfraDataMongoConfiguration {
    ...
    MongoTemplate mongoTemplate() {
      return new MongoTemplate(
          MongoClients.create("mongodb://" + container.getContainerIpAddress() + ":" + container.getFirstMappedPort()),
          "product_management");
    }
  ...
  private static void prepareDatabaseServer() {
    container = new MongoDBContainer(DEFAULT_IMAGE_NAME.withTag(DEFAULT_TAG));
    container.start();
  }
